...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[0.20-0.10, 0.25-0.05],
...
def main():
    ...
    language = "Use only the red mug to push down and tilt up the plate."
    register_task_info(
        language,
    ...
    "plate_1"
        ...
        ("Not", ("InContact", "wooden_shelf_1", "plate_1")),
        ("Not", ("InContact", "wooden_cabinet_1", "plate_1")),
        ("Not", ("InContact", "microwave_1", "plate_1")),
        ("Not", ("InContact", "black_book_1", "plate_1")),
        ("Not", ("InContact", "black_book_2", "plate_1")),
        ("Not", ("InContact", "white_storage_box_1", "plate_1")),
        ("Not", ("InContact", "porcelain_mug_1", "plate_1")),
        ("Not", ("InContact", "cookies_1", "plate_1")),
        ("Not", ("InContact", "milk_1", "plate_1")),
        ("Not", ("InContact", "macaroni_and_cheese_1", "plate_1")),
    ]
    )
