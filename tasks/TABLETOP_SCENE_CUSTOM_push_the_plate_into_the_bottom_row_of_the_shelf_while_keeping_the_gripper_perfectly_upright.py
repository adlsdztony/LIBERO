...
def main():
    ...
    language = "Push the plate into the bottom row of the shelf while keeping the gripper perfectly upright"
    register_task_info(
        language,
    ...
    "wooden_shelf_1"
        ...
        goal_states=[
        ("In", "plate_1", "wooden_shelf_1_bottom_region"),
        ("ConstraintAlways", ("AxisAlignedWithin", "gripper0_hand", "z", 175, 180)),
