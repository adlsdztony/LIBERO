...
def main():
    ...
    language = "Fully open the middle drawer of the cabinet, then pick the yellow book, raise it above the cabinet, and finally drop it so it lands upright inside the drawer"
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        ("Sequential", (
            ...
            ("FlexibleAbove", "yellow_book_1", "wooden_cabinet_1_top_side", 100),
            ("All", (
                ("In", "yellow_book_1", "wooden_cabinet_1_middle_region"),
