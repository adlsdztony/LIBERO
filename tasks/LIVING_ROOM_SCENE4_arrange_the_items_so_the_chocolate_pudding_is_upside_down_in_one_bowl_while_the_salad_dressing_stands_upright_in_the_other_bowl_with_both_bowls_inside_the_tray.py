...
def main():
    ...
    language = "Arrange the items so the chocolate pudding is upside down in one bowl while the salad dressing stands upright in the other bowl with both bowls inside the tray"
    register_task_info(
        language,
        ...
        goal_states=[ 
                        ...
                        ('UpsideDown', 'chocolate_pudding_1'), 
                         ('AxisAlignedWithin', 'new_salad_dressing_1', 'y', '0', '5')
                        ],
    )
