...
def main():
    ...
    language = "Put the mug between the book and the caddy without touching"
    register_task_info(
        language,
    ...
    "white_yellow_mug_1"
        ...
        goal_states=[
        ("RelaxedMidBetween", "black_book_1", "white_yellow_mug_1", "desk_caddy_1", "x"),
        ("Linear", "black_book_1", "white_yellow_mug_1", "desk_caddy_1", 0.0075),
        ("Not", ("InContact", "white_yellow_mug_1", "black_book_1")),
