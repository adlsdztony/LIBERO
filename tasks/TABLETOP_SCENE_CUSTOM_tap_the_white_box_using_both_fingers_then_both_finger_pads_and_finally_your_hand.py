...
def main():
    ...
    language = "Tap the white box using both fingers, then both finger pads and finally your hand"
    register_task_info(
        language,
    ...
    "white_storage_box_1"
        ...
        ("Sequential", (
            ("All", (
                ("InContact", "gripper0_finger1", "white_storage_box_1"), 
                ("InContact", "gripper0_finger2", "white_storage_box_1"), 
            )),
            ("All", (
                ("InContact", "gripper0_finger1_pad", "white_storage_box_1"), 
                ("InContact", "gripper0_finger2_pad", "white_storage_box_1"),
            )),
            ("InContact", "gripper0_hand", "white_storage_box_1"),
        ))
    ]
    )
