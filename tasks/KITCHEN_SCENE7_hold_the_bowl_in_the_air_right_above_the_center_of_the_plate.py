...
def main():
    ...
    language = "Hold the bowl in the air right above the center of the plate"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["white_bowl_1", "microwave_1", "plate_1"],
        goal_states=[
            ("PositionWithinObject", "plate_1", "white_bowl_1", -0.05, -0.05, -2, 0.05, 0.05, 0),
            ("InAir", "white_bowl_1", 0.5),
        ],
    )
