...
def main():
    ...
    language = "Shake milk carton up and down three times by moving it back and forth between the cabinet's top side and middle drawer, then lay it exactly as its starting orientation on the centre of the upright yellow book"
    register_task_info(
        language,
    ...
    "yellow_book_1"
        ...
        goal_states=[
            ("Sequential", (
                ("And", 
                    ("FlexibleAbove", "milk_1", "wooden_cabinet_1_top_side", 100),
                    ("Or",
                        ("InContact", "milk_1", "gripper0_finger1_pad"),
                        ("InContact", "milk_1", "gripper0_finger2_pad"),
                    ),
                ),
                ("And", 
                    ("Not", ("FlexibleAbove", "milk_1", "wooden_cabinet_1_middle_region", 100)),
                    ("Or",
                        ("InContact", "milk_1", "gripper0_finger1_pad"),
                        ("InContact", "milk_1", "gripper0_finger2_pad"),
                    ),
                ...
                ("All", (
                    ("AxisAlignedWithinWorldAxis", "milk_1", "y", 0, 5, "z"),
                    ("On", "milk_1", "yellow_book_1"),
