...
def main():
    ...
    language = "Put two tomato related items within the basket and then pick them out of the basket in the reversed order"
    # print(scene_name.upper() + '_' + '_'.join(language.lower().split()) + '.py')
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["ketchup_1", "tomato_sauce_1", "basket_1"],
        goal_states=[
            ("Any", (
                ("Sequential", (
