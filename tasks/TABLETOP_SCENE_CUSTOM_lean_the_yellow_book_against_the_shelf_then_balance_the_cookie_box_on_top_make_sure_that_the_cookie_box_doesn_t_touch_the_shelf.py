...
def main():
    ...
    language = "Lean the yellow book against the shelf. Then balance the cookie box on top. Make sure that the cookie box doesn't touch the shelf."
    register_task_info(
        language,
    ...
    "wooden_shelf_1"
        ...
        goal_states=[
        ("Not", ("InContact", "wooden_shelf_1", "cookies_1")),
        ("InContact", "yellow_book_1", "cookies_1"),
        ("InContact", "yellow_book_1", "wooden_shelf_1"),
        ("Or", 
            ("AxisAlignedWithin", "yellow_book_1", "z", 1, 85), 
            ("AxisAlignedWithin", "yellow_book_1", "z", 95, 175),
        ),
        ("Not", ("InContact", "gripper0_finger1", "yellow_book_1")),
        ("Not", ("InContact", "gripper0_finger2", "yellow_book_1")),
        ("Not", ("InContact", "gripper0_hand", "yellow_book_1")),
        ("Not", ("InAir", "yellow_book_1", 0.95)),
    ]
    )
