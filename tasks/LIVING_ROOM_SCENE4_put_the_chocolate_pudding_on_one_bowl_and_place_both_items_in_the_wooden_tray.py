...
def main():
    ...
    language = "Put the chocolate pudding lying flat on top of one bowl and place both items in the wooden tray"
    register_task_info(
        language,
        ...
        goal_states=[
            ...
            ('AxisAlignedWithin', 'chocolate_pudding_1', 'z', 170, 180),
            ('PosiGreaterThan', 'chocolate_pudding_1', 'z', 0.5),
