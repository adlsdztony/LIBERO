...
def main():
    ...
    language = "Grab the cream cheese and set it down with the no label side facing the stove"
    register_task_info(
        language,
    ...
    "flat_stove_1"
        ...
        goal_states=[
        ("IsFacingObject", "cream_cheese_1", "flat_stove_1_cook_region", 0, -1, 0, 25),
        ("Not", ("InAir", "cream_cheese_1", 0.9090)),
