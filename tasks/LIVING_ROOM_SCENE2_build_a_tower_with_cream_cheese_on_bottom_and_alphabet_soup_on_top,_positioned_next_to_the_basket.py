...
def main():
    ...
    language = "Build a tower with cream cheese on bottom and alphabet soup on top, positioned next to the basket"
    register_task_info(
        language,
        ...
        goal_states=[
            ...
            ("PositionWithinObjectAnnulus", "alphabet_soup_1", "basket_1", 0.08, 0.15),
