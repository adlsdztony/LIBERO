...
def main():
    ...
    language = "Point curvature in the cookie box's label to the microwave's centre by only pushing it with other objects"
    register_task_info(
        language,
    ...
    "microwave_1"
        ...
        goal_states=[
        ("IsFacingObject", "cookies_1", "microwave_1", 0, 1, 0, 10),
