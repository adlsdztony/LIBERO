...
def main():
    ...
    language = "Put the macaroni and cheese box inside the microwave with it standing on its second tallest side"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["macaroni_and_cheese_1", "microwave_1"],
        goal_states=[
