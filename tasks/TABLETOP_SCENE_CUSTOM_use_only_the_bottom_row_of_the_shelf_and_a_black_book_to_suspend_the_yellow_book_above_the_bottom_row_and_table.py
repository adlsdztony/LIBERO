...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def init_states(self):
        states = [
            ...
            ("On", "plate_1", "wooden_shelf_1_top_side"),
...
def main():
    ...
    language = "Use only the bottom row of the shelf and a black book to suspend the yellow book above the bottom row and table."
    register_task_info(
        language,
    ...
    "yellow_book_1"
        ...
        goal_states=[
        ("Or", ("RelaxedOn", "yellow_book_1", "black_book_1"), ("RelaxedOn", "yellow_book_1", "black_book_2")),
        ("InContact", "wooden_shelf_1", "yellow_book_1"),
        ("Under", "yellow_book_1", "wooden_shelf_1_middle_region"),
        ("InAir", "yellow_book_1", 0.9388),
    ]
    )
