...
def main():
    ...
    language = "Raise the milk carton so its centre is in line with the red mug along the north south direction and the white mug vertically."
    register_task_info(
        language,
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("DistanceBetween", "red_coffee_mug_1", "milk_1", 0.01, 10, 10),
        ("DistanceBetween", "milk_1", "porcelain_mug_1", 10, 10, 0.01),
    ],
    )
