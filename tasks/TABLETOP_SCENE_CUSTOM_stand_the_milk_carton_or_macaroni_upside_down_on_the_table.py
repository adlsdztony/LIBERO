...
def main():
    ...
    language = "Stand the milk carton or macaroni upside down on the table"
    register_task_info(
        language,
    ...
    "macaroni_and_cheese_1"
        ...
        goal_states=[
        ("AxisAlignedWithinWorldAxis", "macaroni_and_cheese_1", "y", 175, 180, "z"),
        ("Not", ("InAir", "macaroni_and_cheese_1", 0.9582)),
