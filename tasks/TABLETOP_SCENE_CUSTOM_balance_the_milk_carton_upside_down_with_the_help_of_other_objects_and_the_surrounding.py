...
def main():
    ...
    language = "Balance the milk carton upside down with the help of other objects and the surrounding. Move the robot arm away afterwards."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
    "milk_1",
    "macaroni_and_cheese_1",
    "cookies_1"
],
        goal_states=[
        ("AxisAlignedWithin", "milk_1", "x", 90, 105),
        ("AxisAlignedWithin", "milk_1", "z", 75, 89),
        ("AxisAlignedWithin", "milk_1", "y", 165, 180),
