...
def main():
    ...
    language = "Put the bowl on the table right next to and touching the plate"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["white_bowl_1", "plate_1", "microwave_1"],
        goal_states=[
            ("On", "white_bowl_1", "kitchen_table_tabletop_region"),
            ("On", "plate_1", "kitchen_table_tabletop_region"),
            ("InContact", "white_bowl_1", "plate_1"),
        ],
    )
