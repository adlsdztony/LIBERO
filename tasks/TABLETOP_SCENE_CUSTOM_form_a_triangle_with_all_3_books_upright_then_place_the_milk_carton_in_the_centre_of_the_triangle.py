...
def main():
    ...
    "milk_1"
        ...
        ("Upright", "black_book_2"),
        ("Upright", "yellow_book_1"),
        ("AxisAlignedWithin", "milk_1", "x", 85, 90),
        ("AxisAlignedWithin", "milk_1", "z", 90, 95),
        ("AxisAlignedWithin", "milk_1", "y", 0, 5),
        ("Not", ("InAir", "milk_1", "0.96973")),
        ("equal", ("distance", "black_book_1", "black_book_2"), ("distance", "yellow_book_1", "black_book_1"), 0.02),
        ("equal", ("distance", "black_book_1", "black_book_2"), ("distance", "yellow_book_1", "black_book_2"), 0.02),
        ("equal", ("distance", "yellow_book_1", "black_book_1"), ("distance", "yellow_book_1", "black_book_2"), 0.02),
        ("equal", ("distance", "black_book_1", "milk_1"), ("distance", "yellow_book_1", "milk_1"), 0.02),
        ("equal", ("distance", "black_book_1", "milk_1"), ("distance", "milk_1", "black_book_2"), 0.02),
        ("equal", ("distance", "yellow_book_1", "milk_1"), ("distance", "milk_1", "black_book_2"), 0.02),
    ]
    )
