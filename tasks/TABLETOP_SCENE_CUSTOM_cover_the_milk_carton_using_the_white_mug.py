...
def main():
    ...
    language = "Cover the milk carton using the white mug"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["milk_1", "porcelain_mug_1"],
        goal_states=[
            ("On", "porcelain_mug_1", "milk_1"),
            ("UpsideDown", "porcelain_mug_1"),
            ("DistanceBetween", "porcelain_mug_1", "milk_1", 10, 10, 0.165), # safety check
        ],
    )
