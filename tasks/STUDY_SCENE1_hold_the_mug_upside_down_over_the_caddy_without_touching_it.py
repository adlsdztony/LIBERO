...
def main():
    ...
    language = "Hold the mug upside down over the caddy without touching it"
    register_task_info(
        language,
    ...
    "desk_caddy_1"
        ...
        ("DistanceBetween", "white_yellow_mug_1", "desk_caddy_1", 0.1, 0.22, 10),
        ("Not", ("InContact", "white_yellow_mug_1", "desk_caddy_1")),
        ("Not", ("InAir", "white_yellow_mug_1", 0.2))
    ]
    )
