...
def main():
    ...
    language = "Sequentially position the gripper so its hand is vertically above the centre of the right black book and then the left black book while making sure that the gripper never touches the yellow book"
    register_task_info(
        language,
    ...
    "yellow_book_1"
        ...
        goal_states=[
        ("Sequential", (
            ("Above", "gripper0_hand", "black_book_1"),    
            ("Above", "gripper0_hand", "black_book_2")
        )),
