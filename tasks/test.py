...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def init_states(self):
        states = [
            ...
            ("On", "black_book_centered_1", "main_table_desk_zone_book_1_region"),
            ("On", "black_book_centered_2", "main_table_desk_zone_book_2_region"),
...
def main():
    ...
    language = "Put a pale book on the shelf, ensuring it is lying flat."
    register_task_info(
        language,
        ...
        goal_states=[
            ("In", "black_book_centered_1", "wooden_shelf_1_top_region"),
            ...
            ("Any", (
                ("And", ("Under", "yellow_book_centered_1", "wooden_shelf_1_top_side"), ("InAir", "yellow_book_centered_1", "1.083")),
                ("And", ("Under", "yellow_book_centered_1", "wooden_shelf_1_top_region"), ("InAir", "yellow_book_centered_1", "1.013")),
                ("And", ("Under", "yellow_book_centered_1", "wooden_shelf_1_middle_region"), ("InAir", "yellow_book_centered_1", "0.943")),
            )),
            ("FlexibleOn", "yellow_book_centered_1", "wooden_shelf_1", 0.10, 0.02),
