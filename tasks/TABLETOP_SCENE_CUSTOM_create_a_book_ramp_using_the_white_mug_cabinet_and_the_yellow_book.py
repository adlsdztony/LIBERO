...
def main():
    ...
    language = "Create a book ramp using the white mug, cabinet and the yellow book on its flat side."
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        goal_states=[
        ("InContact", "yellow_book_1", "porcelain_mug_1"),
        ("InContact", "yellow_book_1", "wooden_cabinet_1"),
        ("Or", 
