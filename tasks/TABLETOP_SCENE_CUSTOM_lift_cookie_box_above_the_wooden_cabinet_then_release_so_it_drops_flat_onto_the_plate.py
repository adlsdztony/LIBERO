...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[0.20-0.10, 0.25-0.07],
...
def main():
    ...
    language = "Lift cookie box above the wooden cabinet, then release so it drops flat onto the plate"
    register_task_info(
        language,
    ...
    "plate_1"
        ...
        goal_states=[
        ("Sequential", (
            ("FlexibleAbove", "cookies_1", "wooden_cabinet_1_top_side", 100),
            ("All", (
                ("Or", ("Upright", "cookies_1"), ("UpsideDown", "cookies_1")),
                ("RelaxedOn", "cookies_1", "plate_1"),
