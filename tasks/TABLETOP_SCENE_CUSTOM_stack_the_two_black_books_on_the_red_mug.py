...
def main():
    ...
    language = "Stack the two black books on the red mug"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["black_book_1", "black_book_2", "red_coffee_mug_1"],
        goal_states=[   
    ...
    ("Or", 
        ("And", ("RelaxedOn", "black_book_1", "red_coffee_mug_1"), ("RelaxedOn", "black_book_2", "black_book_1")),
        ("And", ("RelaxedOn", "black_book_2", "red_coffee_mug_1"), ("RelaxedOn", "black_book_1", "black_book_2"))
    ),
