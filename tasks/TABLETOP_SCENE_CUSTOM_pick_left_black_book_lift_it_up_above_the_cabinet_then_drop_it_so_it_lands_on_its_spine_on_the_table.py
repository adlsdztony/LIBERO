...
def main():
    ...
    language = "Pick left black book, lift it up above the cabinet, then drop it so it lands on its spine on the table"
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        goal_states=[
            ("Sequential", (
                ("FlexibleAbove", "black_book_2", "wooden_cabinet_1_top_side", 100),  
                ("All", (
                    ("FlexibleAbove", "gripper0_finger1_pad", "wooden_cabinet_1_top_side", 100),
                    ("Not", ("FlexibleAbove", "black_book_2", "wooden_cabinet_1_middle_region", 100))
                )),
                ("All", (
                    ("FlexibleAbove", "gripper0_finger1_pad", "wooden_cabinet_1_top_side", 100),
                    ("AxisAlignedWithinWorldAxis", "black_book_2", "z", 90, 95, "z"),
                    ("Not", ("InAir", "black_book_2", 0.945))
                )),              
            ))
    ]
    )
