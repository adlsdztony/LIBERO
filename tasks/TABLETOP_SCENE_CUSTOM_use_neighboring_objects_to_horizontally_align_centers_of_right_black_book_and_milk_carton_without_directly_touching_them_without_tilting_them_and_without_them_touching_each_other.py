...
def main():
    ...
    # language = "Push the milk carton only using the gripper hand until its center horizontally aligns with the right black book's center, without tilting the milk and touching the yellow book"
    language = "Use the neighboring objects to horizontally align the centres of the right black book and milk carton without directly touching them, without tilting them and without them touching eachother"
    register_task_info(
        language,
    ...
    "black_book_1",
        ...
        goal_states=[
        ("PosiSameWith", "milk_1", "black_book_1", "y", 0.02),
        ("ConstraintAlways", ("AxisAlignedWithin", "milk_1", "y", 0, 10)),
        ("ConstraintAlways", ("AxisAlignedWithin", "black_book_1", "z", 0, 10)),
        ("ConstraintNever", ("InContact", "milk_1", "black_book_1")),
