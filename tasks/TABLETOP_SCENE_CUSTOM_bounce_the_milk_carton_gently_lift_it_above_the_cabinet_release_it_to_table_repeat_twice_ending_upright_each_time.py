...
def main():
    ...
    language = "Bounce the milk carton gently: lift it above the cabinet, release it to table, repeat twice, ending upright each time."
    register_task_info(
        language,
        ...
        goal_states=[   
            ("Sequential", (
                ...
                ("And", 
                    ...
                    ("And",
                        ("Not", ("InContact", "milk_1", "gripper0_finger1_pad")),
                        ("Not", ("InContact", "milk_1", "gripper0_finger2_pad")),
                    ),
                ),
                ("And", 
                    ("FlexibleAbove", "milk_1", "wooden_cabinet_1_top_side", 100),
