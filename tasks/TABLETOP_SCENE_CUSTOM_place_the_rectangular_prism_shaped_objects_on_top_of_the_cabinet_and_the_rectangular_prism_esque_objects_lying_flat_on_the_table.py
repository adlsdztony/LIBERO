...
def main():
    ...
    register_task_info(
        ...
        objects_of_interest=[
            "black_book_1", "black_book_2", "yellow_book_1", "cookies_1",
            "milk_1", "macaroni_and_cheese_1",
            "wooden_cabinet_1"
        ],
        goal_states=[
            ("RelaxedOn", "black_book_1", "wooden_cabinet_1"),
            ("RelaxedOn", "black_book_2", "wooden_cabinet_1"),
