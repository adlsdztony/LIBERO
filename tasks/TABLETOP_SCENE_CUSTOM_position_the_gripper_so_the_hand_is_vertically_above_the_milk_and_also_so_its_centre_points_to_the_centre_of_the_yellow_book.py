...
def main():
    ...
    language = "Position the gripper so the hand is right above the milk and also so its centre points to the centre of the yellow book"
    register_task_info(
        language,
    ...
    "yellow_book_1"
        ...
        goal_states=[
        ("Above", "gripper0_hand", "milk_1"),
        ("IsFacingObject", "gripper0_hand", "yellow_book_1", 0, 0, 1, 5)
    ]
    )
