...
def main():
    ...
    language = "Move the red coffee mug forward to one end of the microwave, then backwward past its original position to the opposite end, keeping it upright throughout"
    register_task_info(
        language,
    ...
    "red_coffee_mug_1"
        ...
        goal_states=[
        ("ConstraintAlways", ("Upright", "red_coffee_mug_1")),
        ("Sequential", (
            ("PosiGreaterThan", "red_coffee_mug_1", "x", -0.11),
            ("PosiLessThan", "red_coffee_mug_1", "x", -0.35), 
        )),
    ]
    )
