...
def main():
    ...
    language = "Arrange bowl, cream cheese and wine bottle linearly and hover robot hand above the bowl"
    register_task_info(
        language,
    ...
    "wine_bottle_1",
        ...
        goal_states=[
        ("Linear", "akita_black_bowl_1", "cream_cheese_1", "wine_bottle_1", 0.001),
