...
def print_ee_pose(obs):
    """Print current end effector pose with 7 decimal places"""
    ee_pos = obs["robot0_eef_pos"]
    ee_quat = obs["robot0_eef_quat"]
    print(f"Current EE Pose: [[{ee_pos[0]:.7f}, {ee_pos[1]:.7f}, {ee_pos[2]:.7f}], [{ee_quat[0]:.7f}, {ee_quat[1]:.7f}, {ee_quat[2]:.7f}, {ee_quat[3]:.7f}]],")
